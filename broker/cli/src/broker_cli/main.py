...
# Service-level daemon controls are exposed through `nb`.
# Keep `broker daemon` available for internal wrappers and backwards compatibility.
app.add_typer(daemon.app, name="daemon", hidden=True)
